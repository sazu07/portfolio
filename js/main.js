...
$(window).on('load', function() {
    ...
    if( $('.service-items').length ) {
        var $elements = $(".service-items"),
            $filters = $('.service-filter ul li');
        $elements.isotope();
...
$(document).ready(function() {
    ...
    $('.pt-service .service-items .item figure').tilt({
        maxTilt: 3,
        glare: true,
        maxGlare: .6,
        reverse: true
    ...
    $(".service-items .image-link").magnificPopup({
        type: "image"
    });
	/* -----------------------------------
	      11. Portfolio Video Link
    ...
    $(".service-items .video-link").magnificPopup({
        type: "iframe"
    });
